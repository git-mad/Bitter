...
public interface CommentProvider {
     ...
     * @return the comment with the matching id, or null if the comment does
     * not exist
     */
     ...
     * @return an array of all the comments made by the author, or null if
     ...
     * @return an array of comments for the post, or null if the post does
     * not exist
     */
